(function () {
    ...
    function renderCard(item) {
      ...
      <div class="project-card-media">
        ...
        ${item.video ? '<button class="video-fullscreen-btn" aria-label="View video fullscreen" type="button"><svg viewBox="0 0 24 24"><path d="M8 3H5a2 2 0 00-2 2v3m18 0V5a2 2 0 00-2-2h-3m0 18h3a2 2 0 002-2v-3M3 16v3a2 2 0 002 2h3"/></svg></button>' : ''}
